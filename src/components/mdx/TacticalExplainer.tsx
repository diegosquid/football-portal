  ...
  return (
    <div className="border border-ink/10 bg-cal p-2.5 sm:p-3">
      <svg
        ...
        className="block h-auto w-full"
        role="img"
        aria-label="Fluxo do impedimento semiautomático: câmeras captam o lance, sistema identifica o ponto do passe e a posição dos jogadores, e o VAR valida a decisão"
      >
        ...
        <Player point={[237, 146]} {...OPPONENT} r={10} />
        <Player point={[338, 136]} {...DEFENDER} r={10} />
        <Player point={[414, 153]} {...DEFENDER} r={10} />
        <Ball point={[237, 119]} />
        <line
          x1="338"
          y1="102"
          ...
          strokeDasharray="8 6"
        />
        <Arrow from={[250, 113]} to={[319, 113]} color={COLORS.chalk} dashed />
        <path
          d="M 320 216 C 320 240, 272 238, 272 257"
          fill="none"
          stroke={COLORS.lime}
          strokeWidth="2.5"
          strokeDasharray="6 5"
        />
        <path
          d="M 320 216 C 320 240, 368 238, 368 257"
          fill="none"
          stroke={COLORS.lime}
          strokeWidth="2.5"
          strokeDasharray="6 5"
        ...
        <g
          ...
          fontFamily="var(--font-spline-mono), ui-monospace"
        >
          <text x="26" y="25">CÂMERAS</text>
          <text x="45" y="286">PONTO DO PASSE</text>
          <text x="442" y="286">LINHA DE IMPEDIMENTO</text>
        </g>
      </svg>
    </div>
  );
...
function CriteriaPanel({
  ...
  const method = consistent ? "MESMO MÉTODO" : "MÉTODO MISTO";
      ...
      <svg viewBox="0 0 320 190" className="block h-auto w-full" aria-hidden="true">
        ...
        {[44, 160, 276].map((x) => (
          <g key={x}>
            ...
            <circle cx={x} cy="94" r="8" fill={COLORS.opponent} />
            <line
              x1={x - 21}
              y1="105"
              x2={x + 21}
        ...
        >
          ...
          <text x="160" y="165" fill={color} fontSize="13">{method}</text>
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2">
      ...
      <CriteriaPanel
        ...
        note="um confronto muda de método no meio do mata-mata"
        consistent={false}
      />
    </div>
  );
...
> = {
  ...
  "saot-decision-path": {
    ...
    description:
      "Diagrama explica o fluxo do impedimento semiautomático entre as câmeras do estádio, o ponto do passe, a linha de impedimento e a confirmação do VAR.",
  ...
  "saot-equal-criteria": {
    ...
    caption:
      "No mata-mata, a igualdade não está em colocar os mesmos jogadores em campo: está em submeter cada confronto ao mesmo protocolo de decisão.",
    description:
      "Comparação visual entre uma fase com o mesmo método de análise em todos os jogos e uma fase com métodos diferentes entre os confrontos.",
